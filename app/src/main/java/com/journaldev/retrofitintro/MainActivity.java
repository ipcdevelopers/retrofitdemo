...
import com.journaldev.retrofitintro.pojo.GitResponse;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<GitResponse> call = apiInterface.getGitUser();
    ...
    public static <T> void callRetrofit(Call<T> call, final Object obj) {

        call.enqueue(new Callback<T>() {
            @Override
            public void onResponse(Call<T> call, Response<T> response) {

//                obj = (User) response.body();
